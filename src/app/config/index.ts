...
type JwtExpiresIn = `${number}${"s" | "m" | "h" | "d" | "y"}`;
...
export default {
  ...
  jwt_access_expires_in: process.env.JWT_ACCESS_EXPIRES_IN as JwtExpiresIn,
  jwt_refresh_secret: process.env.JWT_REFRESH_SECRET,
  jwt_refresh_expires_in: process.env.JWT_REFRESH_EXPIRES_IN as JwtExpiresIn,
  jwt_otp_secret: process.env.JWT_OTP_SECRET as JwtExpiresIn,
  jwt_pass_reset_secret: process.env.JWT_PASS_RESET_SECRET,
  jwt_pass_reset_expires_in: process.env
    .JWT_PASS_RESET_EXPIRES_IN as JwtExpiresIn,
